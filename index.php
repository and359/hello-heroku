...
<br><br>	
	...
	***line chart 
	...
	<script>
		...
		var test2 = [{type: 'line', borderColor: 'red', id: 'vline0', mode: 'vertical', scaleID: 'x-axis-0', value: '06/03/2020', borderWidth: 1, label: {enabled: true, position: "top", content: '06/03/2020 Buy Px: 60.650002'}},{type: 'line', borderColor: 'green', id: 'vline1', mode: 'vertical', scaleID: 'x-axis-0', value: '30/07/2020', borderWidth: 1, label: {enabled: true, position: "bottom", content: '30/07/2020 Sell Px: 58.5'}},{type: 'line', borderColor: 'red', id: 'vline2', mode: 'vertical', scaleID: 'x-axis-0', value: '03/11/2020', borderWidth: 1, label: {enabled: true, position: "top", content: '03/11/2020 Buy Px: 57.970001'}},{type: 'line', borderColor: 'red', id: 'vline3', mode: 'vertical', scaleID: 'x-axis-0', value: '30/12/2020', borderWidth: 1, label: {enabled: true, position: "top", content: '30/12/2020 Sell Px: 50.23'}},{type: 'line', borderColor: 'red', id: 'vline4', mode: 'vertical', scaleID: 'x-axis-0', value: '31/12/2020', borderWidth: 1, label: {enabled: true, position: "top", content: '31/12/2020 Buy Px: 44.040001'}},{type: 'line', borderColor: 'red', id: 'vline5', mode: 'vertical', scaleID: 'x-axis-0', value: '25/01/2021', borderWidth: 1, label: {enabled: true, position: "top", content: '25/01/2021 Sell Px: 49.009998'}},{type: 'line', borderColor: 'red', id: 'vline6', mode: 'vertical', scaleID: 'x-axis-0', value: '17/02/2021', borderWidth: 1, label: {enabled: true, position: "top", content: '17/02/2021 Buy Px: 41.650002'}},{type: 'line', borderColor: 'red', id: 'vline7', mode: 'vertical', scaleID: 'x-axis-0', value: '02/03/2021', borderWidth: 1, label: {enabled: true, position: "top", content: '02/03/2021 Sell Px: 42.119999'}}]
