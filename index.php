...
<body>
<h1>S&P500 Performance (PHP) 54</h1>
...
<div class="container">
	...
	<!--Structure Data Loop-->
		...
		var test4 = marketing3.map(function(date2, px2, index2) {
			...
			labels: [{point: {xAxis: 0,yAxis: 0,x: date2,y: px4[px2]},x: -30,text: string(amount4[index2])}]}
			} else {
			return{
			...
			labelOptions: {backgroundColor: 'rgba(255,255,255,0.5)',verticalAlign: 'top',y: 15},labels: [{point: {xAxis: 0,yAxis: 0,x: date2,y: px4[px2]},text: string(amount4[index2])}]}
			};
