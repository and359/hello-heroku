...
<h1>S&P500 Performance (PHP) updated 19</h1>
...
<br><br>	
	...
	***line chart 
	...
	<div class="container">	
	   ...
	   <canvas id="ctx"></canvas><canvas id="chart" style="width: 100%; height: 65vh; background: #222; border: 1px solid #555652; margin-top: 10px;"></canvas>
	<script>
