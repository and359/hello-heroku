...
if ($result->num_rows > 0) {
	...
	echo "<tr id='collapseme' class='collapse out'><td><font color='#ff9900'>" . ++$row_num . ")</font></td><td><font color='#ff9900'>" . $row["Ticker"]. "</font></td><td><font color='#ff9900'>" . $row["Desc_"]. "</font></td><td><font color='#ff9900'>" . $row["LastPx"]. "</font></td><td><font color='#ff9900'>" . $row["RtnPercent"]. "</font></td><td><font color='#ff9900'>" . $row["Sector"]. "</font></td><td><font color='#ff9900'>" . $row["Industry"]. "</font></td><td><font color='#ff9900'>" . $row["Volume"]. "</font></td><td><font color='#ff9900'>" . $row["Index_"]. "</font></td></tr>";
