...
if ($result->num_rows > 0) {
	...
	echo "<table border=1><tr>" . ++$row_num . ") Ticker: " . $row["Ticker"]. " - Desc: " . $row["Desc"]. " - Close Price: " . $row["LastPx"]. " Returns: " . $row["RtnPercent"]. " - Sector: " . $row["Sector"]. " - Industry: " . $row["Industry"]. " - Volume: " . $row["Volume"]. "</td></table>" . "<br>";
    }
} else {
    echo "0 results";
}
